...
import { sendPasswordResetEmail, sendRestSuccessEmail, sendVerficationEmail, sendWelcomeEmail } from '../mailtrap/email.js';
...
export const forgotPassword = async (req,res) => {
    ...
    try{
        ...
        const resetTokenExpiesAt = Date.now() + 1 * 60 * 60 * 1000;  //1 hour

        user.resetPasswordToken = resetToken;
        user.resetPasswordExpiresAt = resetTokenExpiesAt;
