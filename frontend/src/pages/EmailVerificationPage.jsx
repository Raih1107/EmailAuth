...
const EmailVerificationPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(`Verfication code submitted : ${verificationCode}`)
    }
...
return (
    ...
    <p className="text-center text-gray-300 mb-6">
        Enter the 6-dgit code sent to your email address.
    </p>
        ...
        <div className="flex justify-between">
        {
            code.map((digit, index) => (
                <input 
                    ...
                    className="w-12 h-12 text-center text-white text-2xl font-bold bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-green-500"
                />
            ))
        }
